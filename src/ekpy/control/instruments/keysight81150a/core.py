...
def set_output_wf(wavegen, channel: str='1', func='SIN', freq='1e3', voltage='1', offset='0', duty_cycle='50', num_cycles=None):
    """
    ...
    wavegen.write(":VOLT{}:OFFS {}".format(channel, offset))
    wavegen.write(":VOLT{} {}".format(channel, voltage))
    if func.lower() == 'squ' or func.lower() == 'square':
        wavegen.write(":SOUR:FUNC{}:DCYC {}".format(channel, duty_cycle)) #DOES NOT WORK, will need to fix later
